...
# $WINGET_PROGRAMS_ID.Add("Microsoft.VisualStudio.2022.Community") > $null
# $WINGET_PROGRAMS_ID.Add("PDFLabs.PDFtk.Free" > $null) # PDF merge
# $WINGET_PROGRAMS_ID.Add("OpenJS.NodeJS") > $null  # NodeJS
# $WINGET_PROGRAMS_ID.Add("Google.GoogleDrive") > $null
# $WINGET_PROGRAMS_ID.Add("Mozilla.Firefox") > $null
# $WINGET_PROGRAMS_ID.Add("Avidemux.Avidemux") > $null # fast video split,cut ..
...
# $WINGET_PROGRAMS_ID.Add("qBittorrent.qBittorrent") > $null
# $WINGET_PROGRAMS_ID.Add("VideoLAN.VLC") > $null
# $WINGET_PROGRAMS_ID.Add("Nvidia.GeForceNow") > $null
# $WINGET_PROGRAMS_ID.Add("Zoom.Zoom") > $null
